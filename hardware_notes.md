...
If you use pots with "D" type shafts, be aware that not all knobs have the D shaped hole in the same direction. Also, my SMD 2xVCA and 3xCV modules actually have their pots backwards compared to the other modules since I had a bunch of backwards knobs I wanted to use. 
